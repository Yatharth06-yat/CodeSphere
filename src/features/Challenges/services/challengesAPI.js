...
import { challengesMockData } from '../data/challengesMockData'

/**
 * Challenges API layer.
...
export const challengesAPI = {
  getAll: async () => {
    // return axiosInstance.get('/challenges').then((res) => res.data)
    return Promise.resolve(challengesMockData)
  }
}
